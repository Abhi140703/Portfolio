...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden px-6 lg:px-20  py-24 lg:py-40
 bg-bg">
      {/* MOBILE BACKGROUND */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="text-center lg:text-left text-dark">
          <p className="text-sm lg:text-lg font-semibold tracking-wide text-accent mb-3">
 ...
 Hello, my name <br /> is Abhishek DungDung
          ...
          <p className="mt-6 text-lg text-accent max-lg:hidden">
            I build modern, scalable full-stack web applications using MongoDB,
Express, React, and Node.js.
        ...
        <div className="relative flex justify-center items-center">
          ...
          <img
            ...
            alt="Profile"
            className="
              relative z-10 lg:top-2 -mt-8 sm:-mt-4 lg:mt-0
              w-[220px] sm:w-[260px]
...
Express, React, and Node.js.
        ...
        >
          ...
          <a
            href="https://www.linkedin.com/in/abhishek-dungdung-3a4382276"
            target="_blank"
